...
The public repository must be understandable in this order:

1. ordinary Sims players: what it does, whether it is ready, and how to install it;
2. users who already have an AI companion/chat service: whether and how their service can connect;
3. developers and reviewers: architecture, protocol, testing, and extension points.

The README should not assume that readers know this project's internal names. Use ordinary language first and link to technical documents for details.
...
- .gitignore
- pyproject.toml
- README.md is the short Chinese default product entry; README.en.md mirrors the same user-facing facts in English
- README must explain in plain language: what the project does, who can use it now, what is not ready yet, and where to install/test
- detailed installation lives in docs/installation.md; exact platform/game/user support lives in docs/compatibility.md
- technical architecture/protocol details stay in docs instead of crowding the README front page
